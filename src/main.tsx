...
import { createHeroSlides, fallbackLatestVideos, supportCards, youtubeCards } from './config/cards';
import { links } from './config/links';
import { mobileMoreActions, navGroups } from './config/navigation';
import {
  createInitialLiveDetails,
  createInitialLiveStatus,
  createMediaPlayers,
  createStreamChats,
  getTwitchParent,
  testLiveDetails,
...
const twitchParent = getTwitchParent();
const streamChats = createStreamChats(twitchParent);
const mediaPlayers = createMediaPlayers(twitchParent);
const initialLiveStatus = createInitialLiveStatus(mediaPlayers);
const initialLiveDetails = createInitialLiveDetails(mediaPlayers);
